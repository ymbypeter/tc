...
document.writeln("            <img src=\'image/logo_back.png\' alt=\'logo\'>");
document.writeln("        </div>");
...
document.writeln("            <div class=\'pull-down\'>");
document.writeln("                <ul>");
document.writeln("                    <a href=\'bag.html\'><li>我的背包</li></a>");
document.writeln("                    <li>修改資料</li>");
document.writeln("                    <li>登出</li>");
document.writeln("                </ul>");
